      ...
      <div className="w-full max-w-none mx-auto px-4 py-6 sm:px-6 lg:px-8">
        <div className="flex flex-col">
          <div className="flex flex-wrap justify-between items-center w-full mb-1">
            ...
            <a href="https://ethos-b2b.clickoapps.com/login" className="bg-white text-black px-4 py-2 rounded-md text-sm font-medium hover:bg-zinc-200 transition-colors whitespace-nowrap">
              Get Started
            </a>
          </div>
